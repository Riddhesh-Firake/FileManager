  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2"><span className="font-bold text-lg">Recent Files</span><span className="bg-[#B9FF66] border-2 border-[#191A23] text-xs px-2 py-0.5 rounded-full font-bold">{recentFiles.length}</span></div>
      ...
      <div className="flex-1 overflow-y-auto">
        <FileList files={recentFiles} viewMode={viewMode} onAction={() => {}} /> {/* Actions can be passed similar to MyFiles */}
      </div>
    </div>
  );
};
