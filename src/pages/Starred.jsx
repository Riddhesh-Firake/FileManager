  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2"><span className="font-bold text-lg">Starred</span><span className="bg-[#B9FF66] border-2 border-[#191A23] text-xs px-2 py-0.5 rounded-full font-bold">{starredFiles.length}</span></div>
      ...
      <div className="flex-1 overflow-y-auto">
        <FileList files={starredFiles} viewMode={viewMode} onAction={() => {}} />
      </div>
    </div>
  );
};
